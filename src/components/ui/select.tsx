...
function Select({
  dir,
  ...props
}: React.ComponentProps<typeof SelectPrimitive.Root> & { dir?: "ltr" | "rtl" }) {
  // Try to determine dir from context/document if not explicitly passed
  const effectiveDir = dir || (typeof document !== 'undefined' ? document.documentElement.dir as "ltr" | "rtl" : undefined);
  return <SelectPrimitive.Root data-slot="select" dir={effectiveDir} {...props} />;
}
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="size-4 opacity-50 rtl:mr-2 ltr:ml-2" />
